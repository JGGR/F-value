...
use crate::core::{PROJECT_NAME, SHORT_PROJECT_VERSION, PROJECT_VERSION, COMMIT_HASH_PLUS, PROJECT_BUILD_TYPE, PROJECT_BRANCH, RIFERIMENTO_NISECI_HEADER, RIFERIMENTO_NISECI_HEADER_FIELDS, RIFERIMENTO_NISECI_HEADER_FIELD_TYPES, CAMPIONAMENTO_NISECI_HEADER, CAMPIONAMENTO_NISECI_HEADER_FIELDS, CAMPIONAMENTO_NISECI_HEADER_FIELD_TYPES, ANAGRAFICA_NISECI_HEADER, ANAGRAFICA_NISECI_HEADER_FIELDS, ANAGRAFICA_NISECI_HEADER_FIELD_TYPES};
